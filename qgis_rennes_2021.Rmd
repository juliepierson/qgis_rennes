...
<img src="illus/proc_options.png" width="25%">
...
<img src="illus/proc_hist.png" width="25%">

Ici, vous avez accès à toutes les fois où vous avez lancé un outil de la toolbox, classés par date. En sélectionnant une ligne, vous pouvez voir dessous la commande Python correspondante, pratique si vous vouler faire un script pour automatiser un traitement.
...
<img src="illus/ouessant_srtm.png" width="40%">
<img src="illus/ouessant_srtm15.png" width="40%">
...
<img src="illus/proc_resample.png" width="40%">
...
<img src="illus/resample.png" width="95%">

Il ne reste plus ensuite qu'à remplir les valeurs nulles de **srtm_35_03** par celle de ce nouveau raster :

**Boîte à outils QGIS ➔ WhiteboxTools ➔ GIS Analysis - Overlay Tools ➔ UpdateNodataCells** (pour trouver l'outil plus facilement, vous pouvez taper **nodata** dans la barre de recherche).

<img src="illus/updatenodatacells.png" width="90%">

Le résultat doit ressembler à ceci :

<img src="illus/updatenodatacells_res.png" width="60%">
...
<img src="illus/proc_clip.png" width="40%">
...
<img src="illus/zonalstats_vect.png" width="60%">
...
<img src="illus/zonalstats_centroides_qgis.png" width="40%">
...
<img src="illus/zonalstats_centroides_otb.png" width="40%">
...
<img src="illus/table_reclass.png" width="70%">
...
<img src="illus/reclass_res.png" width="50%">
...
<img src="illus/proc_proj.png" width="45%">

Une fois les 2 couches en EPSG:2154, on peut utiliser l'outil **Zonal Histogram** :

<img src="illus/proc_zonal_histogram.png" width="35%">
...
<img src="illus/zonal_hist_table.png" width="95%">
